...
<body>
	<div id="content">
		...
		<div id="footer">
			<p>Copyright &copy; <?= $year?> <em><?= $title?></em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>